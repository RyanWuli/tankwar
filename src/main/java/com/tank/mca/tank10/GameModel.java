package com.tank.mca.tank10;

import com.tank.mca.tank10.cor.BulletTankCollision;
import com.tank.mca.tank10.cor.Collision;
import com.tank.mca.tank10.cor.CollisionChain;
import com.tank.mca.tank10.cor.TankTankCollision;
...
//        System.out.println("--------------> end");
        ...
        for (int i = 0; i < objects.size(); i++) {
            ...
            for (int j = i + 1; j < objects.size(); j++) {
                ...
                c.collide(go, go2); // 判断敌方 tank 是否击中
                c2.collide(go, go2);
            }
            c.collide(go, tank); // 判断我方 tank 是否击中
        }
